      ...
      <div className="w-full lg:w-6/12 px-4 mx-auto items-center justify-center">
        ...
        <div className="grid grid-cols-2 gap-2 my-6">
          ...
          <div className="flex flex-col text-xs md:text-base">
            ...
            <span>{format(new Date(bike?.lastSeenDate!), "do MMM yyyy")}</span>
            <span className="text-primary mt-2 md:mt-4">Location</span>
            <span>{bike?.lastSeenLocation}</span>
            <span>{bike?.county ? bike?.county : bike?.formattedAddress}</span>
          </div>
        </div>
        <Card>
          <CardHeader>
        ...
        {tenant?.uid === bike?.createdBy && !bike?.found && (
          <Card className="my-6">
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                If someone reports sighting your motor bike, you will receive a
